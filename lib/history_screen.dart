...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  void initState() {
    ...
    _autoRefreshTimer =
        Timer.periodic(const Duration(seconds: 5), (timer) => fetchAlerts());
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 1,
        actions: [
          IconButton(onPressed: fetchAlerts, icon: const Icon(Icons.refresh)),
        ],
      ),
          ...
          return Card(
            ...
            child: ListTile(
              leading: CircleAvatar(
                radius: 28,
                backgroundImage:
                imagePath != null ? NetworkImage(imageUrl) : null,
